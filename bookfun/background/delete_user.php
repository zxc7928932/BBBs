...
&nbsp;
        <input type="submit" name="Submit" value="搜索" onClick="return check(form)">
          ...
          $sql=mysql_query("select * from register where Username like '%$keyword%' or singing like '%$keyword%'");//得到用户信息
          ...
          if ($page==""){
            ...
            $sql=mysql_query("select * from register where Username like '%$keyword%' or singing like '%$keyword%' limit $offset,$page_size");
