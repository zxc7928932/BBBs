				...
				<?php
					...
					if ($page==""){
					   ...
					   if (is_numeric($page)){
						...
						$sql=mysql_query("select * from comment where user =$id");//查找当前用户的评论
						$row=mysql_fetch_object($sql);
						$message_count=mysql_num_rows($sql);
						$page_count=ceil($message_count/$page_size);	  	//根据记录总数除以每页显示的记录数求出所分的页数
						$offset=($page-1)*$page_size;						//计算下一页从第几条数据开始循环  
						$sql=mysql_query("select * from comment where user=$id limit $offset, $page_size");//搜索当前页信息
						...
						$sql1=mysql_query("select * from books where id =$book");//得到该评论用户信息
                      ...
                      <table width="550" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <!--  翻页条 -->
							...
							if($page!=1){
							/*  显示“首页”超链接  */
							echo  "<a href=check_info.php?page=1>首页</a>&nbsp;";
							/*  显示“上一页”超链接  */
							echo "<a href=check_info.php?page=".($page-1).">上一页</a>&nbsp;";
							}
							/*  如果当前页不是尾页  */
							if($page<$page_count){
							/*  显示“下一页”超链接  */
							echo "<a href=check_info.php?page=".($page+1).">下一页</a>&nbsp;";
							/*  显示“尾页”超链接  */
							echo  "<a href=check_info.php?page=".$page_count.">尾页</a>";
							}
