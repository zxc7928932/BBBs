<?php 
	...
	{ 
		echo "<script> alert('图片格式不对！');window.location.href='../view/center.php';</script>";
}
...
// has completed.
	...
	$result = mysql_query($cmd)or die("数据库服务器连接错误".mysql_error());
	
	if(!result)
	{
		echo "<script> alert('修改个人信息失败');window.location.href='../view/center.php';</script>";
	}
	else 
	{
		echo "<script> alert('修改个人信息成功');window.location.href='../view/center.php';</script>";
	}
?>