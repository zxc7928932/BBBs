				...
				<?php
					...
					if ($page==""){
					   ...
					   if (is_numeric($page)){
						...
						$sql=mysql_query("select * from comment where bookid =$id");
						$row=mysql_fetch_object($sql);
						$message_count=mysql_num_rows($sql);
						$page_count=ceil($message_count/$page_size);	  	//根据记录总数除以每页显示的记录数求出所分的页数
						$offset=($page-1)*$page_size;						//计算下一页从第几条数据开始循环  
						$sql=mysql_query("select * from comment where bookid =$id limit $offset, $page_size");//搜索当前页信息
						...
						do{
						$user=$row->uid;
						$sql1=mysql_query("select * from user where uid ='$user'");//得到该评论用户信息
                      ...
                      <table width="550" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <!--  翻页条 -->
							...
							if($page!=1){
							/*  显示“首页”超链接  */
							echo  "<a href=check_comment.php?page=1&id=".$id.">首页</a>&nbsp;";
							/*  显示“上一页”超链接  */
							echo "<a href=check_comment.php?page=".($page-1)."&id=".$id.">上一页</a>&nbsp;";
							}
							/*  如果当前页不是尾页  */
							if($page<$page_count){
							/*  显示“下一页”超链接  */
							echo "<a href=check_comment.php?page=".($page+1)."&id=".$id.">下一页</a>&nbsp;";
							/*  显示“尾页”超链接  */
							echo  "<a href=check_comment.php?page=".$page_count."&id=".$id.">尾页</a>";
							}
