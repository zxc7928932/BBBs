...
#book_img {
    ...
    height: 250px;
              ...
              </a></li></ul></div></nav><div class="page-header" style="margin-top: 80px;"><h5><span class="glyphicon glyphicon-map-marker"></span>热门图书<small>&nbsp&nbsp Hot books</small></h5></div><div class="row"><?php echo ($hot_info); if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-sm-6 col-md-4" id="book_form" style="margin-left: 80px"><div class="thumbnail"><img src="/bookfun/Public/Uploads/<?php echo ($vo["image"]); ?>"><div class="caption"><p style=" text-align:center;font-weight:bold;color:blue;"><?php echo ($vo["bookname"]); ?></p><p style=" text-align:center;">作者：<?php echo ($vo["author"]); ?></p><p style=" text-align:center;"><a href=<?php echo ($vo["dir"]); ?> class="btn btn-primary" role="button">详情</a>&nbsp;
