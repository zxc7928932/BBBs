<?php if (!defined('THINK_PATH')) exit();?><html><head><title>个人中心 - book.fun</title><meta charset="UTF-8"><meta name="Author" content="Soleil-kk"><meta name="Keywords" content="book.fun"><meta name="Description" content="兴趣书籍论坛"><link rel="stylesheet" type="text/css" href="__PUBLIC__/v/css/bootstrap.min.css"><link rel="stylesheet" type="text/css" href="__PUBLIC__/v/css/flat-ui.min.css"><style type="text/css">    body,ul,p,h1,h2,form,select,input{
        margin:0;
        padding:0;
    }
    img{
